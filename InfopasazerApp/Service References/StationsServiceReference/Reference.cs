...
namespace InfopasazerApp.StationsServiceReference {
    ...
    [ServiceContract(ConfigurationName="StationsServiceReference.IStations")]
    public interface IStations {
        ...
        [OperationContract(Action="http://tempuri.org/IStations/GetStationForName", ReplyAction="http://tempuri.org/IStations/GetStationForNameResponse")]
        Task<Station> GetStationForNameAsync(string name);
    }
    ...
    public partial class StationsClient : ClientBase<IStations>, IStations {
        ...
        public Task<Station> GetStationForNameAsync(string name) {
            return base.Channel.GetStationForNameAsync(name);
        }
